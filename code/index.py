...
# Exemple de deux listes
# liste1 = create_month_dataFrame("../datasets/2021/decembre/*.csv", False)
# liste2 = create_month_dataFrame("../datasets/2022/janvier/*.csv", False)
#
# liste1.to_csv("liste1.csv")
# liste2.to_csv("liste2.csv")
#
# # Appeler la fonction pour obtenir les éléments non communs
# non_communs_liste1, non_communs_liste2 = elements_non_communs(liste1, liste2)
#
# print("Éléments non communs dans la liste 1 :", non_communs_liste1)
# print("Éléments non communs dans la liste 2 :", non_communs_liste2)
